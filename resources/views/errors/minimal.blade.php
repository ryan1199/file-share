...
<body class="min-h-screen font-sans antialiased bg-base-200/50 dark:bg-base-200 flex flex-row justify-center items-center">
    <x-main full-width>
        <x-slot:content>
            <div class="w-full h-[90vh] flex flex-col space-x-0 space-y-2 items-center justify-start">
                ...
                <div class="w-full h-fit self-start justify-self-start">
                ...
                <div class="w-full h-full max-w-2xl px-4 text-center content-center self-center">
                    ...
                    <div class="text-2xl leading-loose tracking-widest">
                        @yield('message')
                    </div>
                </div>
            </div>
